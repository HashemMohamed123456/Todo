  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: AppColors.background,
        title: const TextCustom(text: 'Add Task',color: AppColors.blue),
         ...
         children: [
           ...
           child: Column(
               ...
               Material(
                 ...
                 child: InkWell(
                   onTap: (){
                     TodoCubit.get(context).takePhotoFromUser();
                   },
                   child: Container(
                   ...
                   child:const  Column(
                     ...
                     children: [
                       ...
                       SizedBox(height: 12,),
                       TextCustom(text: 'Add Image',fontSize: 20,fontWeight: FontWeight.bold,color: AppColors.blue,),
                     ],
                   ),),
                 ),
               )
         ...
         SafeArea(child: ElevatedButton(
           ...
           onPressed: (){
             if(TodoCubit.get(context).formKey.currentState!.validate()){
               TodoCubit.get(context).storeNewTask().then((value){Navigator.pop(context);});
             }
           },
           child: const TextCustom
             (text: 'Add Task',color: AppColors.background,fontSize: 20,),),
         ),
           ],
        ),
      ),
